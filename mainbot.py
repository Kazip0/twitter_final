...
while True:
    user = api.get_user('Kazip05402029')
    api.update_profile(name=f'kazip|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : kazip|{follower_count(user)} Followers')
